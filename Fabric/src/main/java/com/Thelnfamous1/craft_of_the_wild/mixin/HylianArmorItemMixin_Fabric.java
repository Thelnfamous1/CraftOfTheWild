...
public abstract class HylianArmorItemMixin_Fabric extends ArmorItem implements GeoItem{
    @Unique
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    @Unique
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public HylianArmorItemMixin_Fabric(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
