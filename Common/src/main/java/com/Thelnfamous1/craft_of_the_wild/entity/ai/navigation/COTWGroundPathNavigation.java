 ...
 */
public class COTWGroundPathNavigation extends GroundPathNavigation {
    private COTWWalkNodeProcessor customNodeEvaluator;

    public COTWGroundPathNavigation(Mob mob, Level world) {
        super(mob, world);
    }

    @Override
    protected PathFinder createPathFinder(int maxVisitedNodes) {
        this.customNodeEvaluator = new COTWWalkNodeProcessor();
        this.nodeEvaluator = customNodeEvaluator;
        this.nodeEvaluator.setCanPassDoors(true);
        return new COTWPathFinder(this.nodeEvaluator, maxVisitedNodes);
    }
        ...
        do {
            ...
            for (int x = x0; x != x1; x += stepx) {
                for (int z = z0; z != z1; z += stepz) {
                    ...
                    BlockPathTypes below = this.customNodeEvaluator.getBlockPathTypeWithCustomEntitySize(this.level, x, y0 - 1, z, this.mob, 1, 1, 1);
