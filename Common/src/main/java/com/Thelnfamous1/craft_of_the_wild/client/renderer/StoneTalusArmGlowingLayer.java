...
public class StoneTalusArmGlowingLayer<T extends StoneTalusArm> extends AutoGlowingGeoLayer<T> {
    private final Map<String, ResourceLocation> TEXTURE_PATHS = new HashMap<>();
    private final ResourceLocation id;

    public StoneTalusArmGlowingLayer(GeoRenderer<T> renderer, ResourceLocation id) {
        super(renderer);
        this.id = id;
    }
