...
public class RadiantArmorItem extends DyeableArmorItem implements GeoItem {
    ...
    public static boolean isFullSetEquipped(LivingEntity player) {
        return player.getItemBySlot(EquipmentSlot.HEAD).getItem() instanceof RadiantArmorItem &&
                player.getItemBySlot(EquipmentSlot.CHEST).getItem() instanceof RadiantArmorItem &&
                player.getItemBySlot(EquipmentSlot.LEGS).getItem() instanceof RadiantArmorItem &&
                player.getItemBySlot(EquipmentSlot.FEET).getItem() instanceof RadiantArmorItem;
    }
}
