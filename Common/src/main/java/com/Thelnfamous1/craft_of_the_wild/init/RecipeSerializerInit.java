...
public class RecipeSerializerInit {
    ...
    public static final RegistryObject<RecipeSerializer<PotionInfusionRecipe>> POTION_INFUSION = RECIPE_SERIALIZERS.register("potion_infusion", () -> new SimpleCraftingRecipeSerializer<>(PotionInfusionRecipe::new));
