...
import com.Thelnfamous1.craft_of_the_wild.entity.ai.sensor.*;
...
public class SensorInit {
    ...
    public static RegistryObject<SensorType<BlockDisguiseSensor<?>>> BLOCK_DISGUISE = register("block_disguise", BlockDisguiseSensor::new);
